...
# key = Key.find_or_create_by(activation_code: 'globalmodkey', email: 'global@gmail.com')
...
Location.find_or_create_by(name: 'Location 1', address: '123 Main St', key: key)
Location.find_or_create_by(name: 'Location 2', address: '456 Elm St', key: key)
